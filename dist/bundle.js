...
var defaultState = (_defaultState = {}, _defineProperty(_defaultState, _Layout.GOOD, []), _defineProperty(_defaultState, _Layout.BAD, []), _defineProperty(_defaultState, _Layout.NEXT, []), _defineProperty(_defaultState, 'view', _Layout.DEFAULT_VIEW), _defineProperty(_defaultState, 'editing', null), _defaultState);
...
var App = function (_React$Component) {
	...
	_createClass(App, [{
		...
		value: function updateMessage(_ref) {
			...
			this.setState((0, _assign2.default)({}, this.state, mergeState));
		}
	}, {
		key: 'setEditing',
		...
		key: 'setVoteValue',
		value: function setVoteValue(index, value) {
			var newList = this.state[_Layout.BAD].map(function (item, _index) {
				if (index === _index) {
					return (0, _assign2.default)({}, item, { value: value });
				} else {
					return item;
				}
			});

			this.setState(_defineProperty({}, _Layout.BAD, newList));
		}
	}, {
		key: 'addItem',
		...
		value: function increment(idx) {
			var nextList = this.state[_Layout.BAD].map(function (item, _idx) {
				if (_idx === idx) {
					item = (0, _assign2.default)({}, item, { value: item.value + 1 });
				}

				return item;
			});

			this.setState(_defineProperty({}, _Layout.BAD, nextList));
		}
	}, {
		key: 'render',
...
},{"../Layout":56,"lodash/assign":36}],52:[function(require,module,exports){
'use strict';
...
},{"./App":51}],53:[function(require,module,exports){
(function (global){
'use strict';
...
var Layout = function (_React$Component) {
	...
	_createClass(Layout, [{
		...
		value: function render() {
			...
			var setView = this.context.actions.setView;
...
},{"../List":66,"./index":56}],55:[function(require,module,exports){
'use strict';
...
},{"./FocusStyleToggle":53,"./Layout":54,"./constants":55,"./lib/mapIdToTitle":57}],57:[function(require,module,exports){
'use strict';
...
},{"../Layout":56,"./index":66}],60:[function(require,module,exports){
'use strict';
...
},{"../Layout":56,"./index":66}],61:[function(require,module,exports){
'use strict';
...
},{"./lib/preventNonNumericInput":67}],65:[function(require,module,exports){
'use strict';
...
},{"./IncrementButton":58,"./InnerList":59,"./List":60,"./MessageInput":61,"./MessageView":62,"./MessageWrapper":63,"./VoteInput":64,"./constants":65}],67:[function(require,module,exports){
'use strict';
